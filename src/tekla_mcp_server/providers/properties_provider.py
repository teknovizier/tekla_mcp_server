...
def set_elements_properties(
    ...
    try:
        ...
        logger.exception("Error in set_elements_properties")
        return ToolResult(structured_content={"status": "error", "message": str(e)})
...
def get_elements_properties(
    ...
    try:
        ...
        logger.exception("Error in get_elements_properties")
        return ToolResult(structured_content={"status": "error", "message": str(e)})
...
def get_elements_cut_parts() -> ToolResult:
    ...
    try:
        ...
        logger.exception("Error in get_elements_cut_parts")
        return ToolResult(structured_content={"status": "error", "message": str(e)})
...
def compare_elements(
    ...
    try:
        ...
        logger.exception("Error in compare_elements")
        return ToolResult(structured_content={"status": "error", "message": str(e)})
