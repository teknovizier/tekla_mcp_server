...
| Drawings | 🔒 `export_drawings` | Export drawings to DWG/DXF/DGN via the Document Manager export macro. With `export_settings`, a customer setting is used as-is | `marks` (list[str], optional), `drawing_format` (str: `dxf`/`dwg`/`dgn`, default: `dwg`), `version` (str: `2000`/`2004`/`2007`/`2010`/`2013`, default: `2010`), `export_settings` (str, optional) |
