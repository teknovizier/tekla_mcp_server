...
from component_props_mapper import ComponentPropsMapper, map_properties
...
class TestMapAttributes:
    @patch("component_props_mapper.ComponentPropsMapper")
    ...
    @patch("component_props_mapper.ComponentPropsMapper.map_keys")
    @patch("component_props_mapper.ComponentPropsMapper")
