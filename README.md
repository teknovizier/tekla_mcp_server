...
| Properties | `set_elements_properties` | Set properties on selected elements. **For parts:** name, profile, material, finish, class, part/assembly numbering. **For assemblies:** name, assembly numbering. UDAs supported | `name`, `profile`, `material`, `tekla_class`, `finish`, `part_prefix`, `part_start_number`, `assembly_prefix`, `assembly_start_number`, `user_properties` |
